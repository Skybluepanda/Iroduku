...
async function raritySwitch(char, rngRarity, interaction) {
    ...
    if (apityrng >= 99995) {
        ...
        return createDiaCard(char, interaction);
        ...
        return createRedCard(char, interaction);
    } else if (rngRarity >= 95000) {
        player.increment({pity: 1});
        return createPurpleCard(char, interaction);
    } else if (rngRarity >= 80000) {
        player.increment({pity: 1});
        return createBlueCard(char, interaction);
    } else if (rngRarity >= 60000) {
        player.increment({pity: 1});
        return createGreenCard(char, interaction);
    } else {
        player.increment({pity: 1});
        return createWhiteCard(char, interaction);
    }
}
