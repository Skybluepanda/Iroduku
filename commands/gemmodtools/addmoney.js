...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('addmoney')
        .setDescription('adds money to a profile.')
    ...
    async execute(interaction) {
        ...
        try {
            ...
            embedDone.setDescription(`${target.toString()} recieved ${quantity} money!
            Reason: ${reason}`);
            await database.Player.increment({money: quantity}, {where: {playerID: target.id}})
