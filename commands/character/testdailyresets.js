...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            await database.Daily.update({lastDaily: timeReset}, {where: {playerID: userId}});
            await database.Collect.update({lastcollect: timeReset}, {where: {playerID: userId}});
