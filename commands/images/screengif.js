        ...
        collector.on('collect', async i => {
            switch (i.customId){
                case 'approve':
                    ...
                    await sender.increment({ gems: 50*(sent.bonus+1), karma: (sent.bonus+1), xp: 5, imagePrestige: 1});
...
${interaction.user.username} awarded ${50*(sent.bonus+1)} gems ${sent.bonus+1} karma and 5xp to uploader`);
