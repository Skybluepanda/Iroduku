        ...
        collector.on('collect', async i => {
            switch (i.customId){
                case 'approve':
                    ...
                    await sender.increment({ gems: 50*(sent.bonus+1), karma: (sent.bonus+1), xp: 2, imagePrestige: 1});
                    ...
                    await channel.send(`${interaction.user.username} awarded ${50*(sent.bonus+1)}gems ${sent.bonus+1}karma and 2xp to uploader.`)
