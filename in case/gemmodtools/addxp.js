...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('addxp')
        .setDescription('adds xp to a profile.')
        ...
        .addIntegerOption(option => 
            option
                .setName("quantity")
                .setDescription("Quantity of the xp")
                .setRequired(true)
                )
    ...
    async execute(interaction) {
        ...
        try {
            ...
            embedDone.setDescription(`${target.toString()} recieved ${quantity} xp!
            Reason: ${reason}`);
            await database.Player.increment({xp: quantity}, {where: {playerID: target.id}})
